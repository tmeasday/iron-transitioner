...
TransitionedPageManager = Utils.extend(PageManager, {
  ...
  setTemplate: function (template, key) {
    ...
    if (! transitionedYield)
      return;
    
    var type = 'normal';
    if (self.transitionType)
      type = self.transitionType(oldTemplate, newTemplate, type)
...
// Router.prototype.transitionType(function)
  // should set it on the _page
